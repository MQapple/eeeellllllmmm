/*
 * 饿了么牛逼版
 * 拉裤地址：ql repo http://gh.301.ee/https://github.com/Shy-Dai/eeeellllllmmm.git "^ele" "" "USER|common|ql|sendNotify1"
...
async function _0x18a205(_0x24ec6d) {
  let _0x376622 = await _0x3a3d98(_0x24ec6d, "mtop.alsc.user.detail.query", 99, 1);

  if (_0x376622 !== null) {
    if (!_0x19594c(_0x376622.data)) {
      return _0x376622.data;
    } else {
      if (_0x376622.ret) {
        return _0x376622.ret;
      } else {
        console.log(_0x376622);
      }
    }
  }
